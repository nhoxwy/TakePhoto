   ...
   <div class="col-md-5 col-xs-12">
     ...
     <div id="reg">
       <form>
         ...
         <div class="form-group col-sm-12 col-xs-12">
            <input type="password" class="form-control" id="password-reg" placeholder="Mật khẩu">
         </div>
         <div class="form-group col-sm-12 col-xs-12">
            <input type="password" class="form-control" id="re-password-reg" placeholder="Nhập lại mật khẩu">
         </div>
