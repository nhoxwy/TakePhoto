...
<div class="container edit">
			...
			<div class="col-sm-10">
			    ...
			    <div class="tab-pane" id="detail">
					...
					<div class="col-lg-6 skill">
						...
						<h5>Kỹ năng chụp</h5>
						<div class="progress"><div class="progress-bar" id="photo-skill" aria-valuenow="70" style="width:70%">70%</div></div>
						<h5>Kỹ năng quay</h5>
						<div class="progress"><div class="progress-bar" id="film-skill" aria-valuenow="80" style="width:80%">80%</div></div>
						<h5>Xử lý ảnh</h5>
						<div class="progress"><div class="progress-bar" id="pts-skill" aria-valuenow="40" style="width:40%">40%</div></div>
						<h5>Xử lý video</h5>
						<div class="progress"><div class="progress-bar" id="video-skill" aria-valuenow="75" style="width:75%">75%</div></div>
						</div>
			    </div>
	...
	<hr/>
		<div class="row">
			...
			<div class="thumbnail">
				<div class="caption">
					<a href="/index.cfm/user/show-image"><h4 class="group inner list-group-item-heading">Tên Album</h4></a>
				</div>
				<div class="cycler">
