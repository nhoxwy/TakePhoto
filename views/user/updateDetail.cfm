...
<cfoutput>
  <cfif SESSION.isUserLoggedIn EQ true>
    <div id="updateDetail">
      <h1 class="text-center updateDetail-title">Cập nhật thông tin</h1>
      <h3 class="text-center">Thay đổi thông tin chi tiêt của bạn</h3>
      <div class="col-sm-6 col-md-4 col-md-offset-4">
        <div class="account-wall">
          <img class="profile-img" src="https://x.myspacecdn.com/new/common/images/user.png" alt="">
          <form class="form-signin" method="post">
              <textarea class="form-control" name="lastnameUpdate" placeholder="Giới thiệu bản thân bạn" rows="5" required></textarea>
              <input type="text" class="form-control" name="nickname" placeholder="Tên khác" required>
