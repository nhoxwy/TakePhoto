...
<div id="Frl-info">
	<div class="container">
		...
		<div class="col-lg-9 col-md-8 col-sm-6 col-xs-12">
			...
			<p><span class="glyphicon glyphicon-flag"></span> Đến từ: Mỹ Tho (Tiền Giang)</p>
			<p><span class="glyphicon glyphicon-map-marker"></span> Sống tại: TP. Hồ Chí Minh</p>
...
<div id="Frl-skill">	
	<div class="container">
		<div class="col-lg-6">
			<h3>Kỹ năng</h3>
			<h5>Chụp</h5>
			<div class="progress "><div id="photo-skill" aria-valuenow="70" style="width:70%">70%</div></div>
			<h5>Quay</h5>
			<div class="progress"><div id="film-skill" aria-valuenow="80" style="width:80%">80%</div></div>
			<h5>Photoshop</h5>
			<div class="progress"><div id="pts-skill" aria-valuenow="40" style="width:40%">40%</div></div>
			<h5>Video</h5>
			<div class="progress"><div id="video-skill" aria-valuenow="75" style="width:75%">75%</div></div>
			</div> <!--- End Skill --->
		<div class="col-lg-6">
...
<!--- Chọn sẵn thể loại ban đầu cho người dùng --->
        <select class="field-wrap">
	      ...
	      <button type="submit" class="button button-block btn-success"/>Hẹn lịch</button>
      </form>
    </div>
	</div> <!-- /form -->
</div>
